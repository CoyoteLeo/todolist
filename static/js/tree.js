(function (e, t, n, r) {
    ...
    o.prototype.expand = function (e) {
        var t = this;
        e.children("ul,ol").children("li").show(200, function () {
    ...
    o.prototype.collapse = function (e) {
        var t = this;
        e.children("ul,ol").children("li").hide(200, function () {
    ...
    o.prototype.collapseAll = function () {
        var e = this;
        e.$allBranches.not(e.$topLevelBranches).hide(200, function () {
    ...
    o.prototype.expandAll = function () {
        var e = this;
        e.$allBranches.show(200, function () {
